...
* M: In compact mode, performs a 45° move in the direciton of the last set direction flags. (Does nothing in default, R (+Y) gets the magnatude, doing LdistanceTdistanceN in default will do a angle in that mode)
